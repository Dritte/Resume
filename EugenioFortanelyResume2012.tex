...
\section{OBJECTIVE} MIT junior computer science student seeks challenging employment opportunity in software development for summer 2013 
 

\section{EDUCATION} {\sl Massachusetts Institute of Technology} \hfill Expected Graduation June 2014
                \begin{itemize}  \itemsep -2pt %reduce space between items
                        \item Candidate for Bachelor of Science Computer Science and Engineering
                        % \sl will be bold italic in New Century Schoolbook (or
                        % any postscript font) and just slanted in
                        %	Computer Modern (default) font
                        \item Major GPA:4.5/5.0 Overall GPA: 4.5/5.0 
                        \item Coursework includes: Performance Engineering of
                          Software Systems, Artificial Intelligence, Design and
                          Analysis of Algorithms, Intro to Algorithms, Software
                          Construction, Computation Structures, Math for 
                          Computer Science, Linear Algebra, Differential 
                          Equations, Multi-variable Calculus
                \end{itemize}

                {\sl Pflugerville High School} \hfill Graduated May 2010
                 \begin{itemize}  \itemsep -2pt %reduce space between items
                         \item Salutatorian in class of 535 students
                         \item 16 AP Exams including Computer Science AB: 5, Calculus BC: 5, E\&M: 5
                \end{itemize}
